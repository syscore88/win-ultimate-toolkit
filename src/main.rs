...
fn program_info(winget_id: &str, lang_is_pl: bool) -> &'static str {
    if lang_is_pl {
        ...
        "Bitwarden.Bitwarden" => "Darmowy menedżer haseł przechowujący dane w zaszyfrowanym sejfie.",
        "ESET.InternetSecurity" => "Kompleksowa ochrona antywirusowa i zabezpieczenia internetowe ESET.",
        "Malwarebytes.Malwarebytes" => "Skuteczne narzędzie do wykrywania i usuwania złośliwego oprogramowania.",
        "AVG.AVGAntivirusFree" => "Darmowy program antywirusowy chroniący przed wirusami i złośliwym oprogramowaniem.",
        "Avira.FreeSecurity" => "Darmowy pakiet zabezpieczeń: antywirus, VPN i optymalizacja systemu.",
        ...
        "GitHub.GitHubDesktop" => "Graficzny klient do zarządzania repozytoriami Git i GitHub.",
        ...
        "SST.OpenCodeDesktop" => "Aplikacja desktopowa narzędzia AI wspomagającego programowanie.",
        ...
        "NoWinget.PDFgear" => "Darmowy edytor PDF z funkcjami konwersji, edycji i podpisu dokumentów.",
        "TrackerSoftware.PDF-XChangeEditor" => "Rozbudowany edytor PDF do tworzenia, edycji i adnotacji dokumentów.",
        ...
        "AIMP.AIMP" => "Lekki odtwarzacz muzyki z equalizerem, konwerterem audio i obsługą radia internetowego.",
        "LibreWolf.LibreWolf" => "Przeglądarka internetowa oparta na Firefoksie, skupiona na prywatności i bezpieczeństwie.",
        "Playnite.Playnite" => "Menedżer bibliotek gier, łączący Steam, GOG, Epic i inne launchery w jednym miejscu.",
        "NoWinget.Reddit" => "Aplikacja społecznościowa Reddit z forami tematycznymi i dyskusjami.",
        "Surfshark.Surfshark" => "Aplikacja VPN chroniąca prywatność i bezpieczeństwo podczas przeglądania internetu.",
        "NoWinget.VMwareWorkstationPro" => "Profesjonalne narzędzie do wirtualizacji i uruchamiania maszyn wirtualnych.",
        ...
        "Bitwarden.Bitwarden" => "Free password manager that stores your data in an encrypted vault.",
        "ESET.InternetSecurity" => "Comprehensive antivirus and internet security suite by ESET.",
        "Malwarebytes.Malwarebytes" => "Effective tool for detecting and removing malware.",
        "AVG.AVGAntivirusFree" => "Free antivirus program protecting against viruses and malware.",
        "Avira.FreeSecurity" => "Free security suite with antivirus, VPN, and system optimization tools.",
        ...
        "GitHub.GitHubDesktop" => "Graphical client for managing Git and GitHub repositories.",
        ...
        "SST.OpenCodeDesktop" => "Desktop app for the AI coding assistant tool.",
        ...
        "NoWinget.PDFgear" => "Free PDF editor with conversion, editing, and signing features.",
        "TrackerSoftware.PDF-XChangeEditor" => "Feature-rich PDF editor for creating, editing, and annotating documents.",
        ...
        "AIMP.AIMP" => "Lightweight music player with an equalizer, audio converter, and internet radio support.",
        "LibreWolf.LibreWolf" => "Firefox-based web browser focused on privacy and security.",
        "Playnite.Playnite" => "Game library manager that unifies Steam, GOG, Epic, and other launchers in one place.",
        "NoWinget.Reddit" => "Reddit social app with topic-based forums and discussions.",
        "Surfshark.Surfshark" => "VPN app protecting your privacy and security while browsing the internet.",
        "NoWinget.VMwareWorkstationPro" => "Professional virtualization software for running virtual machines.",
...
const CATEGORY_ORDER: [&str; 18] = [
    "all", "browsers", "communicators", "music", "video", "graphics",
    "office", "streaming", "social", "downloads", "network", "development",
    "ai", "security", "system", "gaming", "cloud", "utilities",
];

fn category_label(category: &str, lang_is_pl: bool) -> &'static str {
    if lang_is_pl {
        match category {
            "all" => "📋 Wszystkie",
...
fn program_category(winget_id: &str) -> &'static str {
    match winget_id {
        "NoWinget.ActivePresenter" => "video",
        "axpnet.AeroFTP" => "network",
        "FinalWire.AIDA64.Extreme" => "system",
        "NoWinget.AnimatedWallpaperMaker" => "utilities",
        "AnyDeskSoftwareGmbH.AnyDesk" => "network",
        "AOMEI.Backupper.Standard" => "system",
        "AOMEI.PartitionAssistant" => "system",
        "Apple.AppleMusic" => "music",
        "Apple.AppleTV" => "streaming",
        "Audacity.Audacity" => "music",
        "NoWinget.Automize" => "utilities",
        "Vector35.BinaryNinja" => "development",
        "Microsoft.BingWallpaper" => "utilities",
        "Bitdefender.AntivirusFree" => "security",
        "Bitwarden.Bitwarden" => "security",
        "ESET.InternetSecurity" => "security",
        "Malwarebytes.Malwarebytes" => "security",
        "AVG.AVGAntivirusFree" => "security",
        "Avira.FreeSecurity" => "security",
        "BlackmagicDesign.DaVinciResolve" => "video",
        "BleachBit.BleachBit" => "system",
        "BlenderFoundation.Blender" => "graphics",
        "Blix.BlueMail" => "communicators",
        "Brave.Brave" => "browsers",
        "TechSmith.Camtasia" => "video",
        "Canva.Canva" => "graphics",
        "OpenAI.ChatGPT" => "ai",
        "Clonezilla.Clonezilla" => "system",
        "Codex.Codex" => "ai",
        "Anysphere.Cursor" => "development",
        "DeepL.DeepL" => "ai",
        "Microsoft.DirectX" => "system",
        "Discord.Discord" => "communicators",
        "Disney.DisneyPlus" => "streaming",
        "DMDE.DMDE" => "system",
        "Docker.DockerDesktop" => "development",
        "DOSBox.DOSBox" => "gaming",
        "Doublecmd.Doublecmd" => "utilities",
        "NoWinget.Doxillion" => "utilities",
        "Dropbox.Dropbox" => "cloud",
        "Duolingo.Duolingo" => "utilities",
        "EaseUS.PartitionMaster" => "system",
        "EaseUS.TodoBackup" => "system",
        "NoWinget.FileConverter" => "utilities",
        "TimKosse.FileZilla.Client" => "network",
        "FireAlpaca.FireAlpaca" => "graphics",
        "Mozilla.Firefox" => "browsers",
        "Image-Line.FLStudio" => "music",
        "NoWinget.FormatFactory" => "video",
        "NoWinget.freac" => "music",
        "FreeCAD.FreeCAD" => "graphics",
        "FreeDownloadManager.FreeDownloadManager" => "downloads",
        "GIMP.GIMP.3" => "graphics",
        "Git.Git" => "development",
        "GitHub.GitHubDesktop" => "development",
        "Google.Chrome" => "browsers",
        "Google.GoogleDrive" => "cloud",
        "Google.PlatformTools" => "development",
        "GParted.GParted" => "system",
        "HandBrake.HandBrake" => "video",
        "Hetman.Recovery" => "system",
        "CPUID.HWMonitor" => "system",
        "Inkscape.Inkscape" => "graphics",
        "Instagram.Instagram" => "social",
        "IrfanSkiljan.IrfanView" => "graphics",
        "AppWork.JDownloader" => "downloads",
        "KDE.Kate" => "development",
        "KDE.Kdenlive" => "video",
        "DominikReichl.KeePass" => "security",
        "KiCad.KiCad" => "development",
        "KDE.Krita" => "graphics",
        "TheDocumentFoundation.LibreOffice" => "office",
        "LMMS.LMMS" => "music",
        "LMStudio.LMStudio" => "ai",
        "Mailbird.Mailbird" => "communicators",
        "MediaHuman.AudioConverter" => "music",
        "Mega.MEGASync" => "cloud",
        "MEGOGO.MEGOGO" => "streaming",
        "Microsoft.PCManager" => "system",
        "Microsoft.PowerToys" => "utilities",
        "Microsoft.VisualStudio.2022.Community" => "development",
        "GNU.MidnightCommander" => "utilities",
        "Mixxx.Mixxx" => "music",
        "MartinPesch.mp3DirectCut" => "music",
        "StevenMayall.MusicBee" => "music",
        "Netflix.Netflix" => "streaming",
        "Nextcloud.NextcloudDesktop" => "cloud",
        ...
        "OpenClaw.OpenClawCompanion" => "ai",
        "SST.OpenCodeDesktop" => "development",
        "Opera.Opera" => "browsers",
        "Opera.OperaGX" => "browsers",
        "dotPDN.PaintDotNet" => "graphics",
        ...
        "Qalculate.Qalculate" => "utilities",
        "qBittorrent.qBittorrent" => "downloads",
        "Qmmp.Qmmp" => "music",
        "RawTherapee.RawTherapee" => "graphics",
        "Cockos.REAPER" => "music",
        "reMarkable.reMarkable" => "utilities",
        "Rescuezilla.Rescuezilla" => "system",
        "VSRevoGroup.RevoUninstaller" => "utilities",
        "Roblox.Roblox" => "gaming",
        "Rufus.Rufus" => "system",
        "RustDesk.RustDesk" => "network",
        "Meltytech.Shotcut" => "video",
        "PaulPacifico.ShutterEncoder" => "video",
        ...
        "NoWinget.StrongRecovery" => "system",
        "SumatraPDF.SumatraPDF" => "office",
        "NoWinget.PDFgear" => "office",
        "TrackerSoftware.PDF-XChangeEditor" => "office",
        "Telegram.TelegramDesktop" => "communicators",
        "Ritlabs.TheBat" => "communicators",
        "Mozilla.Thunderbird" => "communicators",
        "TIDAL.TIDAL" => "music",
        "TikTok.TikTok" => "social",
        "Transmission.Transmission" => "downloads",
        "Twitch.Twitch" => "streaming",
        "Meta.VCRedistAll" => "system",
        "ventoy.Ventoy" => "system",
        "Oracle.VirtualBox" => "development",
        "AtomixProductions.VirtualDJ" => "music",
        "VideoLAN.VLC" => "video",
        "VivaldiTechnologies.Vivaldi" => "browsers",
        "VSCodium.VSCodium" => "development",
        "WhatsApp.WhatsApp" => "communicators",
        "RamenSoftware.Windhawk" => "utilities",
        ...
        "NoWinget.4KVideoDownloader" => "downloads",
        "Klocman.BulkCrapUninstaller" => "utilities",
        "TGRMNSoftware.BulkRenameUtility" => "utilities",
        "darktable.darktable" => "graphics",
        "NoWinget.EaseUSVideoDownloader" => "downloads",
        "Fastfetch-cli.Fastfetch" => "system",
        "FreeTubeApp.FreeTube" => "video",
        "GSmartControl.GSmartControl" => "system",
        "ImputNet.Helium" => "browsers",
        "NoWinget.iTubeGo" => "downloads",
        "NoWinget.JavaOpenJDK" => "development",
        "NoWinget.LockHunter" => "utilities",
        "nomacs.nomacs" => "graphics",
        "CalcProgrammer1.OpenRGB" => "system",
        "Pidgin.Pidgin" => "communicators",
        "PuTTY.PuTTY" => "network",
        "Rainmeter.Rainmeter" => "utilities",
        "Genymobile.scrcpy" => "utilities",
        "NoWinget.Sefirah" => "utilities",
        "ShareX.ShareX" => "utilities",
        "NoWinget.SmartRename" => "utilities",
        "NoWinget.SnappyDriverInstaller" => "system",
        "KRTirtho.Spotube" => "music",
        "NoWinget.Tenacity" => "music",
        "zhongyang219.TrafficMonitor" => "system",
        "NoWinget.ytDownloader" => "downloads",
        "AIMP.AIMP" => "music",
        "LibreWolf.LibreWolf" => "browsers",
        "Playnite.Playnite" => "gaming",
        "NoWinget.Reddit" => "social",
        "Surfshark.Surfshark" => "network",
        "NoWinget.VMwareWorkstationPro" => "development",
        _ => "utilities",
    }
}
    ...
    fn default() -> Self {
        let mut app = Self {
            ...
            programs: vec![
                ...
                ("AVG.AVGAntivirusFree", "AVG AntiVirus Free", false),
                ("Avira.FreeSecurity", "Avira Free Security", false),
                ...
                ("Bitwarden.Bitwarden", "Bitwarden", false),
                ...
                ("ESET.InternetSecurity", "ESET Internet Security", false),
                ...
                ("Git.Git", "Git", false),
                ("GitHub.GitHubDesktop", "GitHub Desktop", false),
                ...
                ("LibreWolf.LibreWolf", "LibreWolf", false),
                ...
                ("SST.OpenCodeDesktop", "OpenCode Desktop", false),
                ...
                ("TrackerSoftware.PDF-XChangeEditor", "PDF-XChange Editor", false),
                ("NoWinget.PDFgear", "PDFgear", false),
                ...
                ("Surfshark.Surfshark", "Surfshark", false),
                ...
                ("NoWinget.VMwareWorkstationPro", "VMware Workstation Pro", false),
            ...
            ui.allocate_ui(egui::vec2(ui.available_width(), header_height), |ui| {
                ui.add_enabled_ui(!is_working, |ui| {
                    ...
                    let toggle_label = format!(
                        "{} {} ({})",
                        if self.category_menu_open { "▾" } else { "▸" },
                        if self.lang_is_pl { "Kategorie programów" } else { "Program categories" },
                        category_label(self.selected_category, self.lang_is_pl)
                    );
                    if ui.add_sized([ui.available_width(), 24.0], egui::Button::new(toggle_label)).clicked() {
                        self.category_menu_open = !self.category_menu_open;
                    }
                    if self.category_menu_open {
                        egui::Frame::group(ui.style()).inner_margin(6.0).show(ui, |ui| {
                            egui::Grid::new("category_menu_grid")
                                .num_columns(2)
                                .spacing([6.0, 4.0])
                                .min_col_width((ui.available_width() - 6.0) / 2.0)
                                .show(ui, |ui| {
                                    for (i, cat) in CATEGORY_ORDER.iter().enumerate() {
                                        let is_selected = self.selected_category == *cat;
                                        if ui.selectable_label(is_selected, category_label(cat, self.lang_is_pl)).clicked() {
                ...
                egui::ScrollArea::vertical().id_source("programs_scroll").auto_shrink([false, false]).show(ui, |ui| {
                    ui.add_enabled_ui(!is_working, |ui| {
                        ...
                        for (winget_id, display_name, is_selected) in self.programs.iter_mut() {
                            if selected_category != "all" && program_category(winget_id) != selected_category {
                                continue;
                            }
                            ui.horizontal(|ui| {
...
fn known_choco_id(winget_id: &str) -> Option<&'static str> {
    match winget_id {
        ...
        "Genymobile.scrcpy" => Some("scrcpy"),
        "ShareX.ShareX" => Some("sharex"),
        "NoWinget.VMwareWorkstationPro" => Some("vmwareworkstation"),
        _ => None,
    }
}
...
fn install_package(winget_id: &str, pkg_name: &str, lang_is_pl: bool, status: &Arc<Mutex<String>>, ctx: &egui::Context) -> bool {
    ...
    let url = match winget_id {
        ...
        "Bitwarden.Bitwarden" => "https://bitwarden.com/download/".to_string(),
        "ESET.InternetSecurity" => "https://www.eset.com/int/home/internet-security/download/".to_string(),
        "Malwarebytes.Malwarebytes" => "https://www.malwarebytes.com/download".to_string(),
        "AVG.AVGAntivirusFree" => "https://www.avg.com/en-us/free-antivirus-download".to_string(),
        "Avira.FreeSecurity" => "https://www.avira.com/en/free-security".to_string(),
        ...
        "Codex.Codex" => "https://apps.microsoft.com/detail/9PLM9XGG6VKS".to_string(),
        ...
        "AIMP.AIMP" => "https://www.aimp.ru/?do=download".to_string(),
        "LibreWolf.LibreWolf" => "https://librewolf.net/installation/windows/".to_string(),
        "Playnite.Playnite" => "https://playnite.link/download.html".to_string(),
        "NoWinget.Reddit" => "https://apps.microsoft.com/detail/9NS3RBQ5HV5F".to_string(),
        "Surfshark.Surfshark" => "https://surfshark.com/download/windows".to_string(),
        "NoWinget.VMwareWorkstationPro" => "https://www.vmware.com/products/desktop-hypervisor/workstation-and-fusion".to_string(),
